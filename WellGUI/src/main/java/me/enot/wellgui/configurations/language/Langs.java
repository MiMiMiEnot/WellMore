...
public enum Langs {
    ...
    main__load__load_guis("&fПрогруженно &3{X} &fменю за &3{Y} &fмс"),
    ...
    gui__click__gis__server_full("&cСервер заполнен",
            "&fДля захода на заполненый сервер нужно иметь привилегию &cТень&r или выше"),
